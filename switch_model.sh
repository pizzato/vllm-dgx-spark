...
MODEL_NAMES=(
  ...
  "MiniMax-M2.5-AWQ (AWQ, ~122GiB, MoE, needs trust_remote_code)"
)
...
MODEL_TRUST_REMOTE=(
  ...
  false  # Gemma2-27B
  true   # MiniMax-M2.5-AWQ - requires trust_remote_code
)
